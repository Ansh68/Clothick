...
export default function Women() {
    ...
    const queryUrl = useMemo(() => {
        let url = `${import.meta.env.VITE_API_URL}/api/products?gender=women&`;
    ...
    const { data: products = [], isLoading } = useQuery({
        queryKey: ['products', 'women', queryUrl],
        queryFn: async () => {
        ...
        <div className="bg-white min-h-screen">
            <div className="bg-white border-b border-gray-100">
                <Container className="py-8 text-center">
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Women's Collection</h1>
                    <p className="text-gray-500 mt-2 max-w-xl mx-auto text-sm">
                        Discover our beautiful range of women's fashion. Trending styles for every occasion.
                    </p>
                </Container>
            </div>
