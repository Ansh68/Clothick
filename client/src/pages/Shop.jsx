...
export default function Shop() {
  ...
  const queryUrl = useMemo(() => {
    ...
    return url;
  }, [searchQuery, selectedGender, selectedVariant, selectedStatus, sortBy]);
  ...
  const getFilterLabel = () => {
    ...
    if (selectedGender) return selectedGender.charAt(0).toUpperCase() + selectedGender.slice(1);
    return 'All Products';
  };
      ...
      <div className="bg-white border-b border-gray-100">
        <Container className="py-8 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">
            {searchQuery ? `Search: "${searchQuery}"` : 'Shop Everything'}
          </h1>
          <p className="text-gray-500 mt-2 max-w-xl mx-auto text-sm">
            Explore our entire collection of premium products. Use the filters and sorting options to find exactly what you're looking for.
          </p>
        </Container>
      </div>
      ...
      <Container className="py-8">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            {(selectedGender || selectedVariant || selectedPriceRange || selectedStatus) && (
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <button onClick={() => { setSelectedCategory('all'); setSelectedGender(''); setSelectedVariant(''); setSelectedStatus(''); setSelectedPriceRange(''); }}
            ...
            {isLoading ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-gray-500">Try adjusting your filters or search to find what you're looking for.</p>
              </div>
            ) : (
