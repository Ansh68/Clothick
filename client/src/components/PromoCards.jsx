...
export default function PromoCards() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10">
            ...
            <Link
                to="/new-arrivals"
                className="group relative flex rounded-2xl overflow-hidden h-[280px] md:h-[300px] bg-black cursor-pointer"
            >
                {/* Text Content */}
                <div className="flex flex-col justify-between p-7 md:p-8 z-10 flex-1">
                    <div>
                        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/15 backdrop-blur-sm text-white text-xs font-semibold uppercase tracking-wider mb-5">
                    ...
                    <div>
                        <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white text-black text-sm font-semibold group-hover:bg-gray-100 transition-colors">
                            Shop Now
            ...
            {/* Right Card - Seasonal Sale (Light) */}
            <Link
                to="/offers"
